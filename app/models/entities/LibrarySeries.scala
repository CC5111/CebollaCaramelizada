...
case class Series(id: Long, title: String, description: String, seasonNumber : Int, state: String, image: String)  extends BaseEntity

case class Season(id: Long, seriesID: Long, number:Int, title:String, description: String, epsNumber : Int, state: String, image: String) extends BaseEntity
